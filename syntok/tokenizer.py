...
class Tokenizer:
    ...
    _hyphens_and_underscore = frozenset(_hyphens + "_" + "\u200b\u200c\ufe0f\ufeff")
    """The set of all hyphen Unicode chars, the underscore and the zero-width space and non-joiner and shaders."""
    ...
    _separation = regex.compile(
        ...
        r"\.\.\.|" +  # inner ellipsis
        r"[\u200b\u200c\ufe0f\ufeff]|" +  # zero width space and zero width non-joiner and shaders
